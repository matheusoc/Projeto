...
public class CriarMedPanel extends JPanel{

	private static final long serialVersionUID = 5395448579592053682L;
	...
	public CriarMedPanel(String id){
		this.id = id;
	...
	public Border createBorder() {
		...
		TitledBorder titledBorder = new TitledBorder("Preparação de remédio:");
